                    ...
                    <div v-for="hours in allHours">
                        <div class="row">
                            <div class="col-auto pr-5 py-2" >
                                <span v-text="getPaddedNumber(hours)">時</span>
                            </div>
                            <div class="col-auto p-2" v-for="minutes in room.time_step_values">
                                <button class="btn btn-outline-dark" data-toggle="tooltip" :title="getTimeRange(hours, minutes, room.time_steps)" v-text="getPaddedNumber(minutes)" :disabled="!isReservationAvailable(room.id, hours, minutes)" @click="reserve(room.id, hours, minutes)">
                                </button>
                            </div>
                        </div>
                       </div>
        ...
        methods: {
            ...
            isReservationAvailable(roomId, hours, minutes){
                ...
                const hasReservation = this.reservations.some(reservation => {
                    ...
                    return(
                        parseInt(reservation.room_id) === parseInt(roomId) && reservation.starts_at ===startsAt
                    )
                });
